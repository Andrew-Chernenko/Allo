...
public class MainPage extends BasePage {
    ...
    @FindBy(xpath = "//div[@class='v-header__line v-header__line--second page-container main-header-second-line']")
    private WebElement header;

    @FindBy(xpath = "//div[@class='language']//div[@class='switcher-toggle']")
    private WebElement nightThemeLanguageSwitcher;

    @FindBy(xpath = "//div[@class='language']//div[@class='switcher-toggle']")
    private WebElement dayThemeLanguageSwitch;
    ...
    @FindBy(xpath = "//p[contains(text(),'Смартфони та телефони')]")
    private WebElement firstCategory;

    @FindBy(xpath = "//p[contains(text(),'Побутова техніка')]")
    ...
    public void swapLanguageNightThemeClick() {
        nightThemeLanguageSwitcher.click();
    }

    public void swapLanguageDayThemeClick() {
        dayThemeLanguageSwitch.click();
    }
